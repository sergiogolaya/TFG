...
save_dir = 'C:\Users\sergi\desktop';
...
for m = 1:num_muscles
    ...
    % Curva media
    plot(emg_results.time_vector, muscle_mean, 'b', 'LineWidth', 1.5);
    ...
    for p = 1:size(phases, 1)
        ...
        text(mean(range), yl(2)*0.9, phases{p,1}, ...
...
saveas(gcf, fullfile(save_dir, 'all_muscles_subplot_A4.png'));
print(gcf, fullfile(save_dir, 'all_muscles_subplot_A4.png'), '-dpng', '-r600');
print(gcf, fullfile(save_dir, 'all_muscles_subplot_A4.pdf'), '-dpdf', '-fillpage');
close(gcf);
