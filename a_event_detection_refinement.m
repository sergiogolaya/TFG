...
for i = 1:num_channels
    ...
    envelope_emg(:, i) = (envelope_emg(:, i) - min(envelope_emg(:, i))) / (max(envelope_emg(:, i)) - min(envelope_emg(:, i)));
end
...
for k = 1:size(rep_events, 1)
    ...
    y_patch = [0; 0; 1; 1] * max(envelope_emg(:, 1));
...
disp('Final segmentation verified. Data stored in struct and plot generated.');
